package com.zweicom.uftutorial.server;
...
public class UberFireServerBootstrapper {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(UberFireServerBootstrapper.class);
	...
	@PostConstruct
	private void init() {
		configurationService.toString(); // this line ensures the
											// ConfigurationService bean is
											// really instantiated. do not
											// remove!
